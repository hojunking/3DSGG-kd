...
#run_command train SGGpoint_t1 gcn ./config/SGGpoint.json 0 0 x
#run_command train SGGpoint_b_gcn gcn ./config/SGGpoint.json 0 0 x
run_command train SGGpoint_p_e_gcn gcn ./config/SGGpoint.json 0 0 x
#run_command train SGGpoint_e_gcn gcn ./config/SGGpoint.json 0 0 x
