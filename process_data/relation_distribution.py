...
def read_json(split):
    ...
    selected_scans = set()
    if split == 'train' :
        selected_scans = selected_scans.union(read_txt_to_list('/home/oi/Desktop/song/light_gnn/data/3DSSG_subset/train_scans.txt'))
        with open("/home/oi/Desktop/song/light_gnn/data/3DSSG_subset/relationships_train.json", "r") as read_file:
            data = json.load(read_file)
    elif split == 'val':
        selected_scans = selected_scans.union(read_txt_to_list('/home/oi/Desktop/song/light_gnn/data/3DSSG_subset/validation_scans.txt'))
        with open("/home/oi/Desktop/song/light_gnn/data/3DSSG_subset/relationships_validation.json", "r") as read_file:
            data = json.load(read_file)
    else:
...
class Result_print():
    def __init__(self, root_path, exp_name, classNames, relationNames, use_rio27) -> None:
        self.root = root_path
